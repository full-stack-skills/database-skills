...
Database skills plugin for Claude Code — 5 database reference skills covering PostgreSQL, MySQL, Oracle, Redis, and Elasticsearch. Part of the [full-stack-skills](https://github.com/full-stack-skills) ecosystem maintained by PartMe.AI. Compatible with the [Agent Skills spec](https://agentskills.io).
